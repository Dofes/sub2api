...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'openai_compat' | 'openrouter' | 'glm'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'openai_compat' | 'openrouter' | 'glm'
