...
interface Props {
  ...
  mixedScheduling?: boolean; // For antigravity/openai_compat/openrouter/glm accounts: allow anthropic/gemini groups
}
...
const filteredGroups = computed(() => {
  ...
  // 启用混合调度后，可选择 anthropic/gemini 分组
  const mixedPlatforms = ["antigravity", "openai_compat", "openrouter", "glm"];
  if (mixedPlatforms.includes(props.platform) && props.mixedScheduling) {
