            ...
            <span
              :class="[
                ...
                value === 'anthropic'
                  ...
                  : value === 'openai_compat' || value === 'openrouter'
...
const platformOptions = computed(() => [
  ...
  { value: "openai_compat", label: t("admin.groups.platforms.openai_compat") },
]);
...
const fallbackGroupOptions = computed(() => {
  ...
  const eligibleGroups = groups.value.filter(
    (g) =>
      g.platform === "anthropic" && !g.claude_code_only && g.status === "active"
  );
